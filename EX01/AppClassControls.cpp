...
void Application::ProcessKeyReleased(sf::Event a_event)
{
	...
	case sf::Keyboard::F5:
		m_fRadius1 -= 0.1f;
		m_fRadius1 = std::max(0.1f, m_fRadius1);
		m_pMesh->GenerateStar(m_uSubdivisions, m_fRadius1, m_fRadius2, C_RED);
		break;
	case sf::Keyboard::F6:
		m_fRadius1 += 0.1f;
		m_fRadius1 = std::min(2.0f, m_fRadius1);
		m_pMesh->GenerateStar(m_uSubdivisions, m_fRadius1, m_fRadius2, C_RED);
		break;
	case sf::Keyboard::F7:
		m_fRadius2 -= 0.1f;
		m_fRadius2 = std::max(0.1f, m_fRadius2);
		m_pMesh->GenerateStar(m_uSubdivisions, m_fRadius1, m_fRadius2, C_RED);
		break;
	case sf::Keyboard::F8:
		m_fRadius2 += 0.1f;
		m_fRadius2 = std::min(2.0f, m_fRadius2);
		m_pMesh->GenerateStar(m_uSubdivisions, m_fRadius1, m_fRadius2, C_RED);
		break;
	case sf::Keyboard::F9:
	case sf::Keyboard::Subtract:
		m_uSubdivisions--;
		m_uSubdivisions = std::max(m_uSubdivisions, static_cast<uint>(3));
		m_pMesh->GenerateStar(m_uSubdivisions, m_fRadius1, m_fRadius2, C_RED);
		break;
	case sf::Keyboard::F10:
	case sf::Keyboard::Add:
		m_uSubdivisions++;
		m_uSubdivisions = std::min(m_uSubdivisions, static_cast<uint>(12));
		m_pMesh->GenerateStar(m_uSubdivisions, m_fRadius1, m_fRadius2, C_RED);
		break;
	}
